...
namespace UsExpress.Transport.Api.Models
{
    public class OrderModel
    {
        ...
        public tblOrder ConvertToOrder()
        {
            ...
            result.Code = GenOrderCode(this.Code);
            ...
            result.SenderId = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["SenderId"]);
            result.RecipientShippingInfo = this.RecipientInfo.Map<tblShippingInfo>();
            result.RecipientShippingInfo.Id = this.RecipientInfo.Id;
            result.Exedite = 0;
            result.StoreId = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["StoreId"]);
        ...
        public List<tblPackageInfo> GetPackageInfoFromModel()
        {
            ...
            if (this.Packages != null && this.Packages.Any())
            {
                ...
                foreach (var package in this.Packages)
                {
                    ...
                    p.StoreId = Convert.ToInt32(System.Configuration.ConfigurationManager.AppSettings["StoreId"]);
